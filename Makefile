...
game: main.o camera.o input.o grid.o movement.o turns.o abilities.o
	g++ main.o camera.o input.o grid.o movement.o turns.o abilities.o -o game -lraylib -lm -Wall
